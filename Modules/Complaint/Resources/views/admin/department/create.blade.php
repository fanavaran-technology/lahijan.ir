@extends('admin.layouts.app', ['title' => ' دپارتمان جدید'])
...
@section('content')
    <div class="d-flex justify-content-between">
        <div class="col mb-2">
            <h2 class="h3 mb-0 page-title">ایجاد دپارتمان</h2>
        </div>
    ...
    <form action="{{ route('admin.departements.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
                    ...
                    <div class="card-header" onclick="openCard(this)">
                        <div class="row d-flex justify-content-between px-2">
                            <div>
                                ...
                                <span class="ml-1">ثبت اطلاعات دپارتمان</span>
                            </div>
