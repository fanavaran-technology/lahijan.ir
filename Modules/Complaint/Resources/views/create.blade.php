    ...
    <section class="min-h-screen">
        ...
        <div dir="rtl"
            ...
            <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                ...
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <!--Body-->
                    <div>
                        <label for="first_name" class="block mb-2 text-right text-sm font-medium text-gray-900 dark:text-white">کد پیگیری خود را وارد نمایید</label>
                        <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="کد پیگیری" required>
                    </div>
        ...
        <form action="{{ route('complaints.store') }}" method="post">
            ...
            <section class="min-h-screen">
                ...
                <section class="md:w-8/12 bg-white shadow-sm p-3 md:my-3 mx-1.5 sm:mx-3 md:mx-auto rounded-3xl">
                    ...
                    <section class="flex justify-center py-4">
                        <button type="submit" id="submit-button"
                                class="text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-7 py-3 text-center mb-2">
                            ثبت
                        </button>
                    </section>
                </section>
