@extends('admin.layouts.app', ['title' => 'افزودن دسته بندی جدید'])

@section('content')
    <div class="row d-flex justify-content-between">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h3 mb-0 section-heading">افزودن دسته بندی جدید</h2>
        </div>
    ...
    @endif
    <form action="{{ route('admin.clarification.categories.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
            ...
            <div>
                <button type="submit" id="save-btn" class="btn btn-lg btn-primary mt-2">ایجاد</button>
            </div>
        </div> <!-- .row -->
    </form>
@endsection
