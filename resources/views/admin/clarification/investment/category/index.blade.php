                    ...
                    <div class="card shadow">
                        <div class="card-body table-responsive">
                            ...
                            <table class="table table-striped" id="table-id">
                                ...
                                @forelse($allCatgeories as $menu)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>
                                            <small>{{ Str::limit($menu->title, 120, '...') }}</small>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.clarification.categories.edit', $menu->id) }}"
                                            ...
                                            <form action="{{ route('admin.clarification.categories.destroy', $menu->id) }}"
                                                class="d-inline" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" x-data="{{ $menu->id }}"
