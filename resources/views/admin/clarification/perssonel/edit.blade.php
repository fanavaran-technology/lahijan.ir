@extends('admin.layouts.app', ['title' => 'ویرایش کارمند '])
...
@section('content')
    <div class="row d-flex justify-content-between">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h3 mb-0 section-heading">ویرایش کارمند  </h2>
        </div>
    ...
    @endif
    <form action="{{ route('admin.clarification.perssonels.update' , $perssonel->id) }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" onclick="openCard(this)">
                        <div class="row d-flex justify-content-between px-2">
                            <div>
                                ...
                                <span class="ml-1">تنظیم و ویرایش</span>
                            </div>
                            <span class="card-dropdown-button caret-up">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-caret-down" viewBox="0 0 16 16">
                    ...
                    <div class="card-body">
                        <div class="form-group custom-control custom-checkbox ">
                            <input type="checkbox" name="is_disable" value="1" @checked(old('is_disable' , $perssonel->is_disable))
