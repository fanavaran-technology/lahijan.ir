@extends('admin.layouts.app', ['title' => 'ویرایش حقوق و دستمزد'])
...
@section('content')
    <div class="row d-flex justify-content-between">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h3 mb-0 section-heading">ویرایش حقوق و دستمزد </h2>
        </div>
    ...
    @endif
    <form action="{{ route('admin.clarification.salaries.update' , $salary->id) }}" method="post" id="salaryForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- places content -->
        <div class="form-row">
            ...
            <div class="form-group col-md-12 my-2">
                <input type="text" name="title" value="{{ old('title' , $salary->title) }}"
            ...
            <div class="form-group col-md-12 mt-2">
                <textarea name="description" class="form-control custom-focus" cols="5">{{ old('description' , $salary->description) }}</textarea>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td class="d-flex align-items-center">
                            <input type="number" name="amount[{{ $key }}]" value="{{ old("amount.$key" , $salary->getAmount($perssonel->id)) }}" class="form-control custom-focus url @error("amount.$perssonel->id") is-invalid @enderror mr-2 currency-input"
                                style="width:12rem">
