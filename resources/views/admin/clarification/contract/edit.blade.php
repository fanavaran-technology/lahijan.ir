@extends('admin.layouts.app', ['title' => 'ویرایش قرارداد'])
...
@section('content')
    <div class="row d-flex justify-content-between">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h3 mb-0 section-heading">ویرایش قرارداد</h2>
        </div>
    ...
    @endif
    <form action="{{ route('admin.clarification.contracts.update' , $contract->id) }}" method="post" enctype="multipart/form-data"
        id="form">
        @csrf
        @method("PUT")
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-12 my-2">
                                <input type="text" name="title" value="{{ old('title' , $contract->title) }}" onkeyup="copyToSlug(this)"
                            ...
                            <div class="form-group col-md-12 my-2">
                                <input type="text" name="contractor" value="{{ old('contractor' , $contract->contractor) }}"
                            ...
                            <div class="form-group col-md-12 my-2">
                                <textarea name="detail" id="editor">{{ old('detail' , $contract->detail) }}</textarea>
                            </div>
                        </div>
                    </div> <!-- /. col -->
                    <!-- end places content -->
            ...
            <div class="col-12 col-md-3 my-2 px-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="contract_date" id="contract_date" value="{{ old('contract_date' , $contract->contract_date) }}">
                        <input id="contract_date_view" value="{{ old('contract_date',$contract->contract_date) }}" class="form-control custom-focus">
                        <div class="form-group mt-4 custom-control custom-checkbox">
                            <input type="checkbox" name="is_private" value="1" @checked(old('is_private' , $contract->is_private))
