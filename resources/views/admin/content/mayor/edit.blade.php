@extends('admin.layouts.app', ['title' => 'ویرایش شهردار '])
...
@section('content')
    ...
    <form action="{{ route('admin.content.mayors.update' , $mayor->id) }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        @method('put')
                    ...
                    <div class="card-header" onclick="openCard(this)">
                        <div class="row d-flex justify-content-between px-2">
                            <div>
                                ...
                                <span class="ml-1">ویرایش اطلاعات شهردار</span>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-row">
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <input type="text" name="full_name" value="{{ old('full_name' , $mayor->full_name) }}"
                                    ...
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <input type="text" name="place_birth" value="{{ old('place_birth' , $mayor->place_birth) }}"
                                    ...
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <input type="text" name="term_responsibility" value="{{ old('term_responsibility' , $mayor->term_responsibility ) }}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group custom-control custom-checkbox ">
                            <input type="checkbox" name="status" value="1" @checked(old('status' , $mayor->status))
                        ...
                        <div>
                            ...
                            <img style="width:7rem" src="{{ asset($mayor->image) }}" alt="">
                        </div>

                        <label for="birthdate_view" class="input-title mt-2">
                            تاریخ تولد
                        </label>
                        <input type="hidden" name="birthdate" id="birthdate" value="{{ old('birthdate' , $mayor->birthdate) }}">
                        <input id="birthdate_view" class="form-control custom-focus" value="{{ old('birthdate' , $mayor->birthdate) }}">

                        <label for="recruitment_view" class="input-title mt-2">
                            تاریخ انتصاب
                        </label>
                        <input type="hidden" name="recruitment" id="recruitment" value="{{ old('recruitment' , $mayor->recruitment) }}">
                        <input id="recruitment_view" class="form-control custom-focus" value="{{ old('recruitment' , $mayor->recruitment) }}">
