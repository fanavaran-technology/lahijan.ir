...
@section('content')
    <div class="row d-flex justify-content-between">
      <div class="d-flex justify-content-between align-items-center">
          <h2 class="h3 mb-0 section-heading">افزودن صفحه جدید</h2>
      </div>
    ...
    @endif
    <form action="{{ route('admin.content.pages.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group  custom-control custom-checkbox ">
                            <input type="checkbox" name="is_quick_access" value="1" @checked(old('is_quick_access'))
                                class="custom-control-input" id="is_quick_access">
                            <label class="custom-control-label input-title" for="is_quick_access">افزودن به دسترسی سریع</label>
                        </div>
                    </div>
