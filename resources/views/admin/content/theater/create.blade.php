@extends('admin.layouts.app', ['title' => ' تئاتر جدید'])
...
@section('content')
    <div class="d-flex justify-content-between">
        <div class="col mb-2">
            <h2 class="h3 mb-0 page-title">ایجاد تئاتر</h2>
        </div>
    ...
    <form action="{{ route('admin.content.theater.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
