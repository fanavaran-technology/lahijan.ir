@extends('admin.layouts.app', ['title' => 'نوشتن فراخوان جدید'])
...
@section('content')
    <div class="row d-flex justify-content-between">
      <div class="d-flex justify-content-between align-items-center">
          <h2 class="h3 mb-0 section-heading">افزودن فراخوان جدید</h2>
      </div>
    ...
    @endif
    <form action="{{ route('admin.content.public-calls.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        <div class="mt-2">
                            ...
                            <input id="event_date_view" class="form-control custom-focus">
                        </div>
