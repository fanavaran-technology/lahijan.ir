...
<div class="d-flex justify-content-between">
  ...
  <form action="{{ route('admin.content.sliders.update' , $slider->id) }}" method="post" enctype="multipart/form-data" id="form">
    @csrf
    {{ method_field('put') }}
    <div class="row">
        ...
        <div class="col-12 col-md-3 my-2 px-0">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <img src="{{ asset($slider->image) }}" alt="" height="50" width="80">
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-header" onclick="openCard(this)">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="published_at" id="published_at" value="{{ old('published_at' , $slider->published_at) }}">
