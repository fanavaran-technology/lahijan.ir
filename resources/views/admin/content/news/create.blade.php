...
@section('content')
    <div class="row d-flex justify-content-between">
        ...
        @if ($errors->any())
            <div class="alert w-100 alert-danger d-flex flex-column" role="alert">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12 my-2">
                                    <textarea type="text" name="summery"
                                        ...
                                        class="form-control custom-input-size custom-focus" id="summery">{{ old('summery') }}</textarea>
                                </div>
                                <div class="col-12 slug d-flex">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" id="image_label" value="{{ old('image') }}" class="form-control" name="image"
                                    aria-label="Image" aria-describedby="button-image" autocomplete="off">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-2 custom-control custom-checkbox ">
                                <input type="checkbox" name="is_fire_station" value="1" @checked(old('is_fire_station'))
                                    ...
                                    @cannot('manage_news') checked disabled @endcannot>
                                <label class="custom-control-label input-title"for="is_fire_station">این خبر مربوط به آتش
                                    نشانی است</label>
                            </div>
                            @can('manage_news')
                                <div class="form-group mt-2 custom-control custom-checkbox ">
                                    <input type="checkbox" name="is_auction_tender" value="1"
                                        @checked(old('is_auction_tender')) class="custom-control-input" id="is_auction_tender">
                            ...
                            <div class="form-group custom-control custom-checkbox ">
                                ...
                                <label class="custom-control-label input-title" for="is_draft">این خبر پیش نویس
                                    است</label>
                            </div>
