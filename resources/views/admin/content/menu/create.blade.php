@extends('admin.layouts.app', ['title' => 'افزودن منویی جدید'])
...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.content.menus.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 my-2">
                                ...
                                <input type="text" name="url" value="{{ old('url' , URL::to('/')) }}" @error('url') autofocus="autofocus" @enderror
