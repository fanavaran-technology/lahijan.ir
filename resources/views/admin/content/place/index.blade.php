...
@section('content')
    <div class="row justify-content-center">
        <div class="col">
            <h2 class="h3 mb-0 page-title">اماکن گردشگری
                                ...
                                <thead>
                                    <div class="form-row py-2">
                                        ...
                                        <div class="ml-3 mt-2 custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="status">مکان های فعال</label>
                                        </div>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-decoration-none mr-3" title="گالری"
                                                href="{{ route('admin.content.places.index-gallery', $place->id) }}">
                                            ...
                                            <a href="{{ $place->publicPath() }}" class="text-decoration-none text-info mr-3">
