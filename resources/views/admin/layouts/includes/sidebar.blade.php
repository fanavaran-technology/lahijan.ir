<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <div class="w-100 mb-4 d-flex justify-content-between align-items-center">
        <a class="mx-auto mt-2 flex-fill" href="{{ route('home') }}">
          <img src="{{ asset('images/settings/logo.jpg') }}" alt="logo" class="brand-sm ">
        </a>
        <div>
          <a href="" class="text-dark text-decoration-none mr-2">
          ...
          @can('manage_files')
          <a href="{{ route('fm.tinymce5') }}" target="_blank" class="text-dark text-decoration-none">
