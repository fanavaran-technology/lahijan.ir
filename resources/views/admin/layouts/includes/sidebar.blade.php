            ...
            <div class="d-flex justify-content-between flex-wrap py-3" style="width:5rem">
                @can('setting_manage')
                    <a href="{{ route('admin.settings.index') }}"
                       class="mr-2 text-center text-dark text-decoration-none @active('admin.settings.index') active @endactive mr-2">
                ...
                @endcan
                @can('manage_files')
                    <a href="{{ route('fm.tinymce5') }}" target="_blank"
                       class="mr-2 text-dark text-decoration-none">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
...
active
@endactive">
                    <a href="#places" data-toggle="collapse" aria-expanded="false"
                       class="dropdown-toggle nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
active
@endactive">
                    <a href="#public-call" data-toggle="collapse" aria-expanded="false"
                       class="dropdown-toggle nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="public-call">
                        <li class="nav-item">
                            <a class="nav-link pl-3"
                               href="{{ route('admin.content.public-calls.index') }}"><span
                                    class="ml-1 item-text">همه فراخوان ها </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3"
                               href="{{ route('admin.content.public-calls.create') }}"><span
...
@endactive">
                    ...
                    <li class="nav-item dropdown @active('admin.clarification.department') active @endactive @active('admin.clarification.categories') active @endactive">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="department">
                            ...
                            <li class="nav-item">
                                <a class="nav-link pl-3"
                                   href="{{ route('admin.departements.create') }}"><span
