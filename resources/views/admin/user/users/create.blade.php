...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.user.users.store') }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <input type="text" name="username" value="{{ old('username') }}"
                                            ...
                                            class="form-control url custom-focus" id="username">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-6 my-2">
                                    ...
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <input type="text" name="mobile" value="{{ old('mobile') }}"
                                            ...
                                            class="form-control url custom-focus" id="mobile">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-6 my-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-2 custom-control custom-checkbox ">
                            ...
                            <label class="custom-control-label input-title" for="email_verified_at"> ایمیل تایید شود</label>
                        </div>
                        <div class="form-group mt-2 custom-control custom-checkbox ">
                            <input type="checkbox" name="mobile_verified_at" value="1" @checked(old('mobile_verified_at'))
                                class="custom-control-input" id="mobile_verified_at">
                            <label class="custom-control-label input-title" for="mobile_verified_at"> شماره تلفن تایید شود</label>
                        </div>
                        <div class="form-group mt-2 custom-control custom-checkbox ">
                            <input type="checkbox" name="is_block" value="1" @checked(old('is_block'))
