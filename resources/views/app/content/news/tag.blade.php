@extends('app.layouts.app', ['title' => "شهرداری لاهیجان | #$tag->title"])
...
@section('content')
    <section class="container mt-5 min-h-screen">
        <section class="text-xl sm:text-2xl md:text-3xl font-bold mt-10 text-blue-700 underline">
            #{{ $tag->title }}
        </section>
        ...
        @if($allNews->isEmpty())
            <div class="mt-6 text-gray-500">هیچ محتوایی برای نمایش وجود ندارد.</div>
        @endif
