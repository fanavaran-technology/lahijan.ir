...
<body class="font-vazir">
    ...
    <div class="px-2 sm:px-4 py-2.5 bg-gray-900 w-full rounded-bl-[40px]">
        <div class="container flex flex-wrap items-center mx-3 sm:mx-auto justify-between ">
            ...
            <div class="flex md:order-2 ">
                <a class="text-sm text-gray-300 hover:text-green-500 ml-4" href="{{ route('home') }}">صفحه اصلی</a></li>
                <a class="text-sm text-gray-300 hover:text-green-500 " href="#">تماس با ما</a></li>
            </div>
    ...
    <div class="bg-gray-900  flex flex-col bottom-0 left-0  justify-center  rounded-tr-[40px] h-24 ">
