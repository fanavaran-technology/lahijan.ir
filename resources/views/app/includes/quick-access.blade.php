<section class="bg-white rounded-lg pb-4">
    <section class="p-4">
        ...
        <section class="flex justify-center gap-1 sm:gap-3 flex-wrap mt-4">
            <a href="#"
            ...
            <a href="#"
                ...
                <span class="text-gray-700 text-xs sm:text-sm mt-4">بررسی شکایات</span>
            </a>
            <a href="#"
                class="w-28 sm:w-32 transition-all delay-100 hover:bg-gray-50 hover:shadow-lg h-32 hover:skew-y-2 p-4 flex flex-col items-center justify-center rounded-xl shadow">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-green-600"
                ...
                <span class="text-gray-700 text-xs sm:text-sm mt-4">عوارض خودرو</span>
            </a>
            <a href="#"
                class="w-28 sm:w-32 transition-all delay-100 hover:bg-gray-50 hover:shadow-lg h-32 hover:skew-y-2 p-4 flex flex-col items-center justify-center rounded-xl shadow">
                ...
                <span class="text-gray-700 text-xs sm:text-sm mt-4">معرفی سازمان ها</span>
            </a>
            <a href="#"
                class="w-28 sm:w-32 transition-all delay-100 hover:bg-gray-50 hover:shadow-lg h-32 hover:skew-y-2 p-4 flex flex-col items-center justify-center rounded-xl shadow">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
