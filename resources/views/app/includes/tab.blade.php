<section x-data="{ openTab: 'video' }" class="bg-white rounded-lg pb-4">
    <section>
        <ul
    ...
    <section x-show="openTab === 'photo'" class="px-6 py-2 flex justify-center">
        <a href="#" class="bg-black w-full lg:h-60 rounded-lg hover:cursor-pointer relative">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper h-60">
                    <div class="swiper-slide"><img class="rounded-lg"
                            src="../assets/images/estakhr.jpg">
                        <div
                            class="text-gray-50 z-50  bg-gray-900 p-1 rounded-lg text-sm absolute bottom-2 right-2">
                            تصاویری فوق
                            العاده از
                            شهر زیبای لاهیجان</div>
                    </div>
                    <div class="swiper-slide"><img class="rounded-lg"
                            src="../assets/images/سوستان.jpg">
                        <div
                            class="text-gray-50 z-50  bg-gray-900 p-1  text-sm absolute bottom-2 right-2">
                            تصاویری فوق
                            العاده از
                            شهر زیبای لاهیجان</div>
                    </div>
