    ...
    <section class="mt-5 min-h-screen">
        <section class="grid grid-cols-12">
                ...
                <section class="my-4 bg-gray-50 bg-opacity-50 p-4 md:p-8 text-gray-700 shadow-sm rounded">
                    <section class="flex flex-wrap lg:flex-nowrap space-y-4 md:space-y-4 justify-between gap-2 items-center">
                        <section class="space-y-4 w-screen lg:w-4/6">
                            <!-- title -->
                            <section class="text-lg md:text-2xl text-gray-700 font-bold">{{ $page->title }}</section>
                            <!-- utility -->
                            <section class="flex items-center space-x-3 space-x-reverse text-gray-600">
                                ...
                                <span class="text-sm">{{ jalaliDate($page->created_at, '%d %B، %Y') }}</span>
                            </section>
                        </section>
                    </section>
            ...
            <aside class="col-span-12 md:col-span-3 mx-4 md:mx-2 space-y-4 pt-5 pl-5">
                ...
                <section class="overflow-y-auto px-0 bg-gray-200 rounded-lg  mt-5 shadow-sm bg-opacity-50 rounded">
                    <section class="flex text-gray-700 items-center px-2 py-4 border-b">
                        <span class="font-semibold text-sm">اماکن گردشگری</span>
                    </section>
                    <ul class="mt-2 divide-y">
                                ...
                                <a href="{{ $place->publicPath() }}"
                                   class="relative flex items-center p-2 text-base transition-all delay-150 ease-in-out hover:bg-gray-50 border-r-2 hover:border-green-500 space-x-2 space-x-reverse">
                                    <div class="space-y-2 flex">
                                        <img src="{{ asset($place->image) }}" class="w-16 h-16 object-cover rounded-2xl" alt="">
                                       <div>
                                           <h5 class="flex-1 font-bold pl-3 mr-2 md:text-xs lg:text-sm text-gray-600">
                                               {{ $place->title }}
                                           </h5>
